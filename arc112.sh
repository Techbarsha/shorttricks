...
# Completion message
echo -e "${RED_TEXT}${BOLD_TEXT}Congrats For Completion Lab Successfully!${RESET_FORMAT}"
echo -e "${GREEN_TEXT}${BOLD_TEXT}Check out our Channel: \e]8;;https://www.youtube.com/@Arcade61432\e\\https://www.youtube.com/@edutechbarsha\e]8;;\e\\${RESET_FORMAT}"
