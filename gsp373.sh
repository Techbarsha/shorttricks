...
echo "${RANDOM_BG_COLOR}${RANDOM_TEXT_COLOR}${BOLD}Now Starting Execution!${RESET}"
...
case "${CHOICE^^}" in
    ...
    N)
        ...
        echo -e "${BOLD}${CYAN}https://www.youtube.com/@edutechbarsha${RESET}"
        ;;
    *)
